...
std::string prefix = "./BaryDataRot0.5_3/";
std:: string inifile = "./BaryDataRot0.5_3/psi_phi_ground.dat";
...
const Float xl = -6.0f, yl = -6.0f, zl = -6.0f;
const Float xr = 6.0f, yr = 6.0f, zr = 6.0f;

#ifndef KERNEL
// Simulation parameters
const Float tau = 0.009;//10;					// Time step (units of [T])
...
const Float omega0 = 0.53;//0.0001;				// Initial angular velocity (in rad/[T])
